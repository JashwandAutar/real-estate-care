...
<template>
    <form>
        ...
        <span class="p-float-label">
            <InputText id="locatie" v-model="modifications.location" />
            <label for="locatie">Locatie</label>
        </span>
        <br>
        <Dropdown v-model="modifications.executedBy" :options="modificatieUitgevoerd" optionLabel="name" placeholder="Uitgevoerd door: " class="w-full md:w-14rem" />
        <br>
        <Textarea v-model="modifications.description" rows="5" cols="30" placeholder="Beschrijving modificatie" />
        <br>
        <Dropdown v-model="modifications.actionToBeTaken" :options="modificatieActie" optionLabel="name" placeholder="Te ondernemen actie" class="w-full md:w-14rem" />
        <br>
        <Textarea v-model="modifications.comments" rows="5" cols="30" placeholder="Opmerkingen" />
        <br>
